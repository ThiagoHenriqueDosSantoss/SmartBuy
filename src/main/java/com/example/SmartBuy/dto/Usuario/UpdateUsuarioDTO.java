...
public class UpdateUsuarioDTO {
    ...
    public UpdateUsuarioDTO(String nome, String email, String senha, String cpf, String cnpj, UsuarioEnum tipo, LocalDateTime dataCriacao, LocalDateTime dataAtualizacao) {
        this.nome = nome;
        this.email = email;
        this.senha = senha;
        this.cpf = cpf;
